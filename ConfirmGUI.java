...
public class ConfirmGUI extends JFrame implements ActionListener, WindowListener {
	...
	/**
	 * Creating a method which is used when the calculateExcessXharge button is
	 * clicked. Once the button is clicked the method checks if the bag width,
	 * height, length and weight is valid. If every input is valid then it add the
	 * baggage to the passenger and changes the check-in to true. The excess baggage
	 * charge is calculated by dividing the allowed weight on a flight by the total
	 * possible passengers on a flight. The passenger's baggage weight is subtracted
	 * from the allowed baggage weight per passenger, and if this value is greater
	 * than zero, then the amount greater than zero is multiplied by the excess
	 * charge value.
	 * 
	...
	/**
	 * Creating a method to check if the baggage width is valid by using if
	 * statements. It ensures the baggage width is an int, between 0 and 100 and
	 * doesn't equal 0.
	 * 
	...
	/**
	 * Creating a method to check if the baggage length is valid by using if
	 * statements. It ensures the baggage length is an int, between 0 and 100 and
	 * doesn't equal 0.
	 * 
	...
	/**
	 * Creating a method to check if the baggage height is valid by using if
	 * statements. It ensures the baggage height is an int, between 0 and 100 and
	 * doesn't equal 0.
	 * 
	...
	/**
	 * Creating a method to check if the baggage weight is valid by using if
	 * statements. It ensures the baggage width is a double, between 0 and 1000 and
	 * doesn't equal 0.
	 * 
